...
export default function Register({children}:formRegister) {
    return(
    <section className="bg-black flex items-center justify-center space-x-24 w-full h-screen bg-bgColor relative overflow-hidden">
      {/* background */}
      ...
      {/* background */}
        ...
        <div className="flex flex-col justify-center border border-gray-400 rounded-2xl items-center h-[80%] px-[60px] z-10 backdrop-blur-2xl">
