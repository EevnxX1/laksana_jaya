...
import { InputTabelProyekDetail } from "@/app/user/admin/buku_proyek/detail/page";
import { TabelProyekDetail1 } from "@/app/user/admin/buku_proyek/detail/page";
import { TabelProyekDetail2 } from "@/app/user/admin/buku_proyek/detail/page";
import { LinkImageProyekDetail } from "@/app/user/admin/buku_proyek/detail/page";
  ...
  return (
    <section className="relative mx-auto w-[91vw] rounded-xl bg-white/20 px-8 py-8">
      <h1 className="text-2xl font-semibold mb-5">
        Pengadaan AC DKUKMPP Kota Cirebon
      </h1>
      ...
      <div className="mt-10 flex flex-col gap-y-5 mb-10">
        ...
        <Link
          ...
          className="flex items-center px-5 gap-x-2 bg-[#F0FF66] text-black self-end w-fit"
        >
