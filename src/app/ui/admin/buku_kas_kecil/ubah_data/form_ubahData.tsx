...
export default function FormBkkUbahData({ children, judul, ...rest }: FormBkb) {
  return (
    <section className="relative w-[91vw] h-[80vh] min-[1100px]:h-auto mx-auto rounded-xl bg-white/20 px-14 py-14 min-[1100px]:px-28">
      <h1 className="font-bold text-white text-2xl mb-10">{judul}</h1>
      <form {...rest} className="flex flex-col items-end gap-y-8">
        ...
        >
          ...
          <span className="ml-1">Ubah Transaksi</span>
        </button>
      </form>
    </section>
  );
...
export function FormTambahData({ children, judul, btn, ...rest }: FormBkb) {
  return (
    <section className="relative w-[91vw] h-[80vh] min-[1100px]:h-auto mx-auto rounded-xl bg-white/20 px-14 py-14 min-[1100px]:px-28">
      <h1 className="font-bold text-white text-2xl mb-10">{judul}</h1>
      <form {...rest} className="flex flex-col items-end gap-y-8">
